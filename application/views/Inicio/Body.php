<main class="ps-main">
            ...
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div class="ps-masonry">
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        ...
                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item nike">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item adidas">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item men">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item women">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/6.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/7.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/8.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
      ...
      <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="<?php echo base_url();?>/Plantilla/images/banner/home-banner-1.png" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="<?php echo base_url();?>/Plantilla/images/banner/home-banner-2.png" alt=""></a></div>
      </div>
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                        ...
                        <div class="ps-hotspot__content">
                          <p class="heading">JUMP TO HEADER</p>
                          <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                        </div></a><img src="<?php echo base_url();?>/Plantilla/images/hot-deal.png" alt=""></div>
                  </div>
            </div>
          </div>
        </div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div>
                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="<?php echo base_url();?>/Plantilla/images/shoe/2.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/3.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/4.jpg" alt=""><img src="<?php echo base_url();?>/Plantilla/images/shoe/5.jpg" alt=""></div>
        ...
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>/Plantilla/images/testimonial/1.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
            ...
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>/Plantilla/images/testimonial/2.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
            ...
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>/Plantilla/images/testimonial/3.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="<?php echo base_url();?>/Plantilla/images/blog/1.jpg" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="<?php echo base_url();?>/Plantilla/images/blog/2.jpg" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="<?php echo base_url();?>/Plantilla/images/blog/3.jpg" alt=""></div>
            ...
            <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                      <header><a class="ps-logo" href="index.html"><img src="<?php echo base_url();?>/Plantilla/images/logo-white.png" alt=""></a>
