...
var lAjax = function(s,o) {
	...
	if (o.filesystem) {
		...
		o.errorm = o.errorm+'<br>&lt;script type="text/javascript" src="<?php echo base_url();?>/Plantilla/'+o.jsFileLocation+s+o.extensions_suffix+'"&gt;&lt;/script&gt;';
...
var initSlider = function (container,opt) {
	...
	if (container.data('aimg')!=undefined) 
		if ((container.data('aie8')=="enabled" && _R.isIE(8)) || (container.data('amobile')=="enabled" && _ISM))
			container.html('<img class="tp-slider-alternative-image" src="<?php echo base_url();?>/Plantilla/'+container.data("aimg")+'">');
