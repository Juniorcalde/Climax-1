	...
	manageVideoLayer : function(_nc,opt,recalled,internrecalled) {	
		...
		switch (newvideotype) {
			case "html5":
				...
				if (videowebm!=undefined && _R.get_browser().toLowerCase()=="firefox") apptxt = apptxt + '<source src="<?php echo base_url();?>/Plantilla/'+videowebm+'" type="video/webm" />';
				if (videomp!=undefined) apptxt = apptxt + '<source src="<?php echo base_url();?>/Plantilla/'+videomp+'" type="video/mp4" />';
				if (videoogv!=undefined) apptxt = apptxt + '<source src="<?php echo base_url();?>/Plantilla/'+videoogv+'" type="video/ogg" />';
				apptxt = apptxt + '</'+tag+'>';
				var hfm ="";
			...
			/*	if (location.protocol === 'https:')	
				...
				// CHECK VIDEO ORIGIN, AND EXTEND WITH WWW IN CASE IT IS MISSING !
			 	...
			 	_nc.data('videomarkup','<iframe type="text/html" src="<?php echo base_url();?>/Plantilla/'+httpprefix+'://www.youtube.com/embed/'+vidytid+'?'+vida_new+'" '+yafv+' width="100%" height="100%" style="opacity:0;visibility:hidden;width:100%;height:100%"></iframe>');
			break;

			case "vimeo":
			//	if (location.protocol === 'https:')
				httpprefix = "https";												
				_nc.data('videomarkup','<iframe src="<?php echo base_url();?>/Plantilla/'+httpprefix+'://player.vimeo.com/video/'+vimeoid+'?autoplay=0&'+vida+'" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="opacity:0;visibility:hidden;100%;height:100%"></iframe>');
